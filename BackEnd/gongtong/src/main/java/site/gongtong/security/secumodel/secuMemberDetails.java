...
public class secuMemberDetails implements UserDetails {

    private Member member;
//    private secuMember member;

    public secuMemberDetails(Member member) {
        this.member = member;
    }
//    public secuMemberDetails(secuMember member) {
//        this.member = member;
//    }
